...
public class SQLProvider 
{
	...
	// ============= STUDENT SIGN UP FUNCTIONS ===============

	public boolean insertStudentUser(Sign_up sign2) //USED TO ENTER STUDENTS INTO THE DATABSE (FINISHED)
	{
		String insertSql = "INSERT INTO student_services_portal.student (student_id, student_first_name, student_last_name, student_email, student_password)"
							+"values('"+sign2.getID()+"', '"+sign2.getFname()+"','"+sign2.getLname()+"','"+sign2.getEmail()+"','"+sign2.getPassword()+"')";
	...
	public boolean insertStudentContact(Sign_up sign2) //USED TO ENTER CONTACTS FOR STUDENTS (FINISHED)
	{
		String insertSql1 = "INSERT INTO student_services_portal.student_contact (student_id, student_contact_number)" + "values('"+sign2.getID()+"', '"+sign2.getPhone()+"')";
		try {
			stmt = (Statement) dbConn.createStatement();
	...
	/*
	public boolean insertStaffUser(Sign_up sign2) //USED TO ENTER STAFF INTO THE DATABSE (FINISHED)
	{
	...
	public boolean insertStaffContact(Sign_up sign2)//USED TO ENTER CONTACTS FOR STAFF (FINISHED)
	{
		String insertstaffSql1 = "INSERT INTO student_services_portal.staff_contact (staff_id, staff_contact_number)" + "values('"+sign2.getID()+"', '"+sign2.getPhone()+"')";
		try {
			stmt = (Statement) dbConn.createStatement();
	...
	*/
	...
	// ============= VIEW STUDENT ENQUIRY FUNCTIONS ===============
	...
	// ============= SUBMIT STUDENT ENQUIRY FUNCTIONS ===============
	...
	*/ 
	...
	// ============= EDIT STUDENT ENQUIRY FUNCTIONS ===============
	...
	// ============= CANCEL STUDENT ENQUIRY FUNCTIONS ===============
	...
	// ============= VIEW ENQUIRY RESPONSES FUNCTION ===============
	...
	// ============= VIEW ALL STUDENT ENQUIRY FUNCTIONS | STUDENT DASHBOARD===============
    @SuppressWarnings("deprecation")
